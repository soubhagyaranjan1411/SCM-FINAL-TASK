...
def Booking():
                ...
                # type and it's price
                if ch==0:
                        print(" 1. Standard Non-AC - Rs. 1500")
                        print(" 2. Standard AC - Rs. 2000")
                        print(" 3. 3-Bed Non-AC - Rs. 2500")
                        print(" 4. 3-Bed AC - Rs. 3000")
                        ch=int(input("->"))
                if ch==1:
        ...
        for n in range(0,i):
                if ph==phno[n] :
                        ...
                        if p[n]==0:
                                ...
                                if dis == "ABCDE":
                                    d=d+1000
                                    print("Disocunt of 1000 applied")
                                elif dis == "UVXYZ":
                                    d=d+2000
                                    print("Discount of 2000 applied")
                                ...
                                if ch=='y' or ch=='Y':
                                        ...
                                        print(" Discount: ",d)
                                        print(" --------------------------------")                                        
                                        print(" Taxable Amount: ",g)                                       
                                        print(" Total Tax(18% GST): ",h)
                                        print(" --------------------------------")
                                        print("\n Total Amount: ",total,"\t")
                                        print(" --------------------------------")
                                        print("          Thank You")
...
def Record():
        ...
        if staffname == "Sparsh":
                ...
                if staffpass == "1234":
                        if phno!=[]:
                                print("  *** HOTEL RECORD ***\n")
                                print("|      Name        |Customer Id| Phone No. |     Address    | Check-In | Check-Out |  Room Type   |     Price     |")
                                print("---------------------------------------------------------------------------------------------------------------------------------------")
                
                                for n in range(0,i):
                                        print("|",   name[n],"\t |",custid[n],"\t|", phno[n] ,"\t|",   add[n],"\t|",checkin[n],"\t|",checkout[n],"\t|",room[n],"\t|",price[n])
